...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, \
         ...
         KC_TAB, KC_GRAVE, KC_FN7, KC_FN1, KC_FN8, KC_FN9, \
         // KC_MINS and KC_LBRC are inverse-dvorakized
	 KC_FN10, KC_FN11, KC_FN2, KC_QUOT, KC_LBRC, KC_ESC), \
  ...
  KEYMAP(KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10, KC_PGUP, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, \
         KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_PGDN, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, \
         KC_F11, KC_F12, KC_F13, KC_F14, KC_F15, KC_INS,  KC_HOME, KC_END,  KC_TRNS, KC_TRNS, \
         SHIFT(KC_TAB), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_FN0), \
  ...
  [1] = ACTION_LAYER_TAP_KEY(1, KC_BSPC),  // to layer 1 while held, space when tapped
  [2] = ACTION_LAYER_TAP_KEY(2, KC_SPC),  // to layer 2 while held, space when tapped
  [3] = ACTION_LAYER_ON(3, 1),  // to hard dvorak
  [4] = ACTION_LAYER_TAP_KEY(4, KC_BSPC),  // to hard dvorak's fn
  [5] = ACTION_LAYER_TAP_KEY(5, KC_SPC),  // switch to layer 2 hard
  [6] = ACTION_LAYER_OFF(3, 1), // to soft dvorak

  [7] = ACTION_MODS_TAP_KEY(MOD_LGUI, KC_SPC),
  [8] = ACTION_MODS_TAP_KEY(MOD_LSFT, KC_BSPC),
  [9] = ACTION_MODS_TAP_KEY(MOD_LCTL, KC_DELETE),
  [10] = ACTION_MODS_TAP_KEY(MOD_LALT, KC_ENT),
