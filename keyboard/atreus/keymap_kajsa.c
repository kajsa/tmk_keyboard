...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, \
         ...
         KC_ESC, KC_TAB, KC_LCTL, KC_FN0, KC_BSPC, KC_FN11, KC_FN12,     \
         // KC_MINS and KC_LBRC are inverse-dvorakized
         KC_SPC, KC_FN13, KC_QUOT, KC_LBRC, KC_ENT),                     \
  /* 1: fn with undvorak-ized punctuation */
  KEYMAP(KC_1, KC_2, KC_3, KC_4, KC_5, \
         SHIFT(KC_SLASH), SHIFT(KC_MINUS), SHIFT(KC_EQUAL), KC_MINUS, KC_EQUAL, \
         KC_6, KC_7, KC_8, KC_9, KC_0, \
         KC_SLASH, SHIFT(KC_9), SHIFT(KC_0), KC_QUOT, SHIFT(KC_QUOT), \
         KC_SCLN, KC_LEFT, KC_DOWN, KC_RIGHT, KC_UP, \
         SHIFT(KC_1), KC_LBRC, SHIFT(KC_LBRC), SHIFT(KC_BSLS), KC_BSLS, \
         KC_NO, KC_TAB, KC_LCTL, KC_FN0, KC_FN14, KC_FN11, KC_FN12, \
  ...
  KEYMAP(KC_INS, KC_HOME, KC_UP, KC_END, KC_PGUP, KC_UP, KC_F7, KC_F8, KC_F9, KC_F10, \
         ...
         KC_NO, KC_FN13, KC_LCTL, KC_FN4, KC_BSPC, KC_FN11, KC_FN12, KC_SPC, KC_FN2, KC_NO, KC_NO, KC_ENT), \
  /* 3: hard dvorak */
  KEYMAP(KC_QUOT, KC_COMM, KC_DOT, KC_P, KC_Y, KC_F, KC_G, KC_C, KC_R, KC_L, \
         KC_A, KC_O, KC_E, KC_U, KC_I, KC_D, KC_H, KC_T, KC_N, KC_S, \
         KC_SCLN, KC_Q, KC_J, KC_K, KC_X, KC_B, KC_M, KC_W, KC_V, KC_Z, \
         KC_ESC, KC_TAB, KC_LCTL, KC_FN13, KC_BSPC, KC_FN11, KC_FN12,     \
  ...
  KEYMAP(KC_1, KC_2, KC_3, KC_4, KC_5, \
         ...
         KC_6, KC_7, KC_8, KC_9, KC_0, \
         KC_SLASH, KC_MINUS, SHIFT(KC_MINUS), SHIFT(KC_9), SHIFT(KC_0), \
         KC_SCLN, KC_LEFT, KC_DOWN, KC_RIGHT, KC_UP, \
  ...
  KEYMAP(SHIFT(KC_1), SHIFT(KC_2), SHIFT(KC_LBRC), SHIFT(KC_RBRC), SHIFT(KC_BSLS), \
         ...
         KC_FN7, SHIFT(KC_INS), KC_LCTL, KC_FN13, KC_BSPC, KC_FN11, KC_FN12, \
  ...
  [14] = ACTION_MODS_TAP_KEY(MOD_LSFT, KC_BSPC),
  };
